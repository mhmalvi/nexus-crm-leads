...
class LeadScraper extends Controller
{
    ...
    public function dataScraper(Request $request){
       ...
       // try {
            ...
            $url = "https://graph.facebook.com/v17.0/me?fields=id,name,adaccounts{campaigns.limit(15){name,start_time,stop_time,status,ads{leads.limit(10000)}},business_name}&access_token=".$accessToken;
