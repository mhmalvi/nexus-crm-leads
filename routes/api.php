...
Route::group(['middleware' => 'companyAuthentication'], function () {
    ...
    Route::post('/company_id={id}/checklist-delete', [
        \App\Http\Controllers\Api\ChecklistMailController::class,
        'delete_checklist'
    ]);
    Route::get('/company_id={id}/checklist-fetch', [
        \App\Http\Controllers\Api\ChecklistMailController::class,
        'fetch_checklist'
    ]);
...
Route::group(['middleware' => ['companyandsalesAuthentication']], function () {
    ...
    Route::get('/lead/lead_id={lead_id}/lead-status-logs', [
        \App\Http\Controllers\Api\LeadController::class,
        'lead_status_logs'
    ]);
    ...
    Route::post(
        ...
        [\App\Http\Controllers\Api\ChecklistMailController::class, 'destroy_mail_template']
    );
